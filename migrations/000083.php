...
if ($db->exec('CREATE TABLE IF NOT EXISTS push_subscriptions (
    ...
    error_log('Wallos: migration 000083 could not create push_subscriptions: ' . $db->lastErrorMsg());
...
if ($db->exec('CREATE INDEX IF NOT EXISTS idx_push_subscriptions_user
    ...
    error_log('Wallos: migration 000083 could not create the user index: ' . $db->lastErrorMsg());
