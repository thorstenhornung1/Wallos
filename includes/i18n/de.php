...
$i18n = [
    ...
    "cost_vs_monthly_budget" => "Kosten vs. monatliches Budget",
    "cost_vs_period_budget" => "Kosten vs. Zeitraumbudget",
    "send_period_summary_at_period_start" => "Zusammenfassung zu Beginn jedes Zahlungszeitraums senden",
    "amount_for_pay_period" => "Betrag für Zahlungszeitraum",
    "remaining" => "Verbleibend",
    "amount_needed_this_period" => "Benötigter Betrag in diesem Zeitraum",
    ...
    "frankfurter_info" => "Kostenlose tägliche Referenzkurse aus institutionellen Quellen. Kein Konto, kein API-Schlüssel und kein Anfragekontingent.",
    "frankfurter_no_crypto" => "Frankfurter kennt keine Kryptowährungen: BTC und ETH stehen nicht im Katalog. Edelmetalle wie XAU und XAG dagegen schon. Bleib bei Fixer, wenn du etwas in Krypto abgerechnetes verfolgst.",
    "ai_model" => "AI Modell",
    ...
    "ai_provider_error" => "Fehler des AI-Anbieters",
    "ai_invalid_response" => "Der AI-Anbieter hat eine ungültige Antwort gesendet.",
    "ai_invalid_json_response" => "Die AI-Antwort enthielt keine gültigen Empfehlungen.",
    ...
    "backup_failed" => "Die Sicherung konnte nicht erstellt werden.",
    "backup" => "Backup",
    "no_file_uploaded" => "Es wurde keine Datei hochgeladen.",
    "restore_failed" => "Die Sicherung konnte nicht wiederhergestellt werden.",
    "restore_successful" => "Die Sicherung wurde wiederhergestellt.",
    ...
    "error_saving_logo" => "Fehler beim Speichern des Logos.",
    ...
    "oidc_admin_claim" => "Administrator-Claim (z. B. groups)",
    "oidc_admin_value" => "Wert im Claim (z. B. Wallos Admins)",
    ...
    "currency_quota_exhausted" => "Das Provider-Kontingent ist aufgebraucht — die Kurse werden bis zum Reset nicht aktualisiert",
    "currency_no_provider_quota" => "Dieser Anbieter meldet keinen Kontingent-Verbrauch",
    "currency_provider_without_quota" => "Dieser Anbieter hat kein Anfragekontingent, es kann also keines aufgebraucht werden",
    "currency_requests_sent" => "Von Wallos gesendete Anfragen in diesem Monat",
    "currency_rates_last_updated" => "Kurse zuletzt aktualisiert",
    ...
    "allow_standard_users_local_webhooks" => "Standardbenutzern erlauben, die Webhook-Zulassungsliste zu verwenden",
    "allow_standard_users_local_webhooks_info" => "Sicherheitsrisiko: Wenn Sie dies aktivieren, kann jeder Standardbenutzer (kein Administrator) Benachrichtigungen an die oben in der Webhook-Zulassungsliste angegebenen Adressen senden, einschließlich interner Dienste in Ihrem Netzwerk. Aktivieren Sie dies nur, wenn Sie jedem Benutzer dieser Wallos-Instanz vertrauen.",
    ...
    "auth_tagline" => "Wissen Sie, wohin Ihr Geld fließt.",
    "auth_tagline_sub" => "Behalten Sie Ihre Abonnements im Blick, sehen Sie Ihre Ausgaben und verpassen Sie keine Verlängerung.",
    "overview" => "Übersicht",
    "trends_and_forecast" => "Trends & Prognose",
    "history_and_lifetime" => "Verlauf & Gesamt",
    "cost_per_day" => "Kosten pro Tag",
    "median_monthly_cost" => "Median der monatlichen Abo-Kosten",
    "cheapest_subscription" => "Günstigstes Abonnement",
    "vs_last_month" => "ggü. Vormonat",
    "heaviest_month" => "Teuerster kommender Monat",
    "months_over_budget" => "Monate über Budget (nächste 12)",
    "manual_renewals" => "Manuelle Verlängerungen",
    "all_time_spend" => "Gesamtausgaben (geschätzt)",
    "oldest_subscription" => "Ältestes Abonnement (Jahre)",
    "average_subscription_age" => "Durchschnittliches Abo-Alter (Jahre)",
    "projected_cost" => "Prognostizierte Kosten (nächste 12 Monate)",
    "lifetime_spend" => "Gesamtausgaben (Top 10, geschätzt)",
    "billing_cycle_split" => "Verteilung nach Abrechnungszyklus",
    "currency_split" => "Verteilung nach Währung",
    "price_distribution" => "Preisverteilung",
    "subscriptions_count" => "Abonnements",
    "new_subscriptions_per_year" => "Neue Abonnements pro Jahr",
    "estimated_from_current_prices" => "Geschätzt anhand aktueller Preise",
    "translate_categories" => "Mit KI übersetzen",
    "week_starts_on_sunday" => "Woche im Kalender mit Sonntag beginnen",
    ...
    // Instanzkonfiguration und geteilte Integrationen
    "smtp_transport" => "SMTP-Transport",
    "use_instance_smtp" => "SMTP der Instanz verwenden",
    "use_custom_smtp" => "Eigenes SMTP verwenden",
    "instance_smtp_not_configured" => "Das SMTP der Instanz ist nicht konfiguriert.",
    "smtp_from_name" => "Absendername (optional)",
    "currency_provider" => "Währungsanbieter",
    "use_instance_provider" => "Anbieter der Instanz verwenden",
    "use_custom_provider" => "Eigenen Anbieter verwenden",
    "instance_currency_provider_not_configured" => "Der Währungsanbieter der Instanz ist nicht konfiguriert.",
    "shared_instance_quota" => "Dieser Anbieter-Schlüssel wird von der gesamten Instanz genutzt, daher ist auch das Anfragekontingent geteilt.",
    "ai_provider" => "KI-Anbieter",
    "use_instance_ai_provider" => "KI-Anbieter der Instanz verwenden",
    "instance_ai_provider_not_configured" => "Der KI-Anbieter der Instanz ist nicht konfiguriert.",
    "instance_ai_model_override_info" => "Lassen Sie das Modell leer, um das Modell der Instanz zu verwenden.",
    "instance_integrations" => "Integrationen der Instanz",
    "instance_integrations_info" => "Diese Zugangsdaten werden von allen Benutzern verwendet, die keine eigenen konfiguriert haben. Werte aus Umgebungsvariablen oder Secret-Dateien werden schreibgeschützt angezeigt.",
    "configured" => "Konfiguriert",
    "not_configured" => "Nicht konfiguriert",
    "managed_externally" => "Extern verwaltet",
    ...
    // Default payment methods a new account starts with. Only the generic
    // names carry a key; brand names (PayPal, SEPA, ...) are seeded literally.
    ...
    // Default currency names a new account starts with. Only the name is
    // translated; the code and symbol are canonical. Needs a human review pass.
    "currency_name_eur" => "Euro",
    "currency_name_usd" => "US-Dollar",
    "currency_name_jpy" => "Japanischer Yen",
    "currency_name_bgn" => "Bulgarischer Lew",
    "currency_name_czk" => "Tschechische Krone",
    "currency_name_dkk" => "Dänische Krone",
    "currency_name_gbp" => "Britisches Pfund Sterling",
    "currency_name_huf" => "Ungarischer Forint",
    "currency_name_pln" => "Polnischer Zloty",
    "currency_name_ron" => "Rumänischer Leu",
    "currency_name_sek" => "Schwedische Krone",
    "currency_name_chf" => "Schweizer Franken",
    "currency_name_isk" => "Isländische Krone",
    "currency_name_nok" => "Norwegische Krone",
    "currency_name_rub" => "Russischer Rubel",
    "currency_name_try" => "Türkische Lira",
    "currency_name_aud" => "Australischer Dollar",
    "currency_name_brl" => "Brasilianischer Real",
    "currency_name_cad" => "Kanadischer Dollar",
    "currency_name_cny" => "Chinesischer Yuan",
    "currency_name_hkd" => "Hongkong-Dollar",
    "currency_name_idr" => "Indonesische Rupiah",
    "currency_name_ils" => "Israelischer neuer Schekel",
    "currency_name_inr" => "Indische Rupie",
    "currency_name_krw" => "Südkoreanischer Won",
    "currency_name_mxn" => "Mexikanischer Peso",
    "currency_name_myr" => "Malaysischer Ringgit",
    "currency_name_nzd" => "Neuseeland-Dollar",
    "currency_name_php" => "Philippinischer Peso",
    "currency_name_sgd" => "Singapur-Dollar",
    "currency_name_thb" => "Thailändischer Baht",
    "currency_name_zar" => "Südafrikanischer Rand",
    "currency_name_uah" => "Ukrainische Hrywnja",
    "currency_name_twd" => "Neuer Taiwan-Dollar",
    // UI attributes that used to be hardcoded English (issue #160)
    "change_avatar" => "Avatar ändern",
    "delete_avatar" => "Avatar löschen",
    "currency_name" => "Währungsname",
    "currency_codes" => "Währungscodes",
    "get_fixer_api_key" => "Kostenlosen Fixer-API-Schlüssel erhalten",
    "oidc_diagnostics" => "Konfigurationsprüfung",
    "database_diagnostics" => "Datenbank",
    "database_backend" => "Backend",
    "database_source" => "Daten",
    "database_backend_default" => "nicht konfiguriert — das ist die Voreinstellung",
    "database_diagnostics_hint" => "Welche Datenbank diese Instanz tatsächlich verwendet. SQLite ist auch das, worauf eine nicht konfigurierte Instanz zurückfällt — ein als Voreinstellung markiertes Backend ist also möglicherweise nicht das gewollte.",
