...
$i18n = [
    ...
    // translated; the code and symbol are canonical.
    "currency_name_eur" => "Euro",
    "currency_name_usd" => "US Dollar",
    "currency_name_jpy" => "Japanese Yen",
    "currency_name_bgn" => "Bulgarian Lev",
    "currency_name_czk" => "Czech Republic Koruna",
    "currency_name_dkk" => "Danish Krone",
    "currency_name_gbp" => "British Pound Sterling",
    "currency_name_huf" => "Hungarian Forint",
    "currency_name_pln" => "Polish Zloty",
    "currency_name_ron" => "Romanian Leu",
    "currency_name_sek" => "Swedish Krona",
    "currency_name_chf" => "Swiss Franc",
    "currency_name_isk" => "Icelandic Króna",
    "currency_name_nok" => "Norwegian Krone",
    "currency_name_rub" => "Russian Ruble",
    "currency_name_try" => "Turkish Lira",
    "currency_name_aud" => "Australian Dollar",
    "currency_name_brl" => "Brazilian Real",
    "currency_name_cad" => "Canadian Dollar",
    "currency_name_cny" => "Chinese Yuan",
    "currency_name_hkd" => "Hong Kong Dollar",
    "currency_name_idr" => "Indonesian Rupiah",
    "currency_name_ils" => "Israeli New Sheqel",
    "currency_name_inr" => "Indian Rupee",
    "currency_name_krw" => "South Korean Won",
    "currency_name_mxn" => "Mexican Peso",
    "currency_name_myr" => "Malaysian Ringgit",
    "currency_name_nzd" => "New Zealand Dollar",
    "currency_name_php" => "Philippine Peso",
    "currency_name_sgd" => "Singapore Dollar",
    "currency_name_thb" => "Thai Baht",
    "currency_name_zar" => "South African Rand",
    "currency_name_uah" => "Ukrainian Hryvnia",
    "currency_name_twd" => "New Taiwan Dollar",
    // UI attributes that used to be hardcoded English (issue #160)
    "change_avatar" => "Change Avatar",
    "delete_avatar" => "Delete avatar",
    "currency_name" => "Currency Name",
    "currency_codes" => "Currency codes",
    "get_fixer_api_key" => "Get free fixer api key",
