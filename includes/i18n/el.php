...
$i18n = [
    ...
    "Yearly" => "Ετήσια",
    "One-time" => "Εφάπαξ",
    "lifetime_purchases" => "Αγορές δια βίου",
    "weekly" => "Εβδομάδα",
    "monthly" => "Μήνας(ες)",
    "yearly" => "Χρόνος(ια)",
    "one-time" => "Εφάπαξ",
    ...
    "cost_vs_monthly_budget" => "Κόστος έναντι Μηνιαίου Προϋπολογισμού",
    "cost_vs_period_budget" => "Κόστος έναντι Προϋπολογισμού Περιόδου",
    "send_period_summary_at_period_start" => "Αποστολή σύνοψης στην αρχή κάθε περιόδου πληρωμής",
    "amount_for_pay_period" => "Ποσό για την Περίοδο Πληρωμής",
    "remaining" => "Υπόλοιπο",
    "amount_needed_this_period" => "Απαιτούμενο ποσό αυτή την περίοδο",
    ...
    "push_notifications_info" => "Λάβετε ειδοποίηση στο πρόγραμμα περιήγησής σας ή στην οθόνη κλειδώματος του τηλεφώνου σας, χωρίς δικό της λογαριασμό ή εφαρμογή. Λειτουργεί σε Chrome, Firefox και Edge desktop, σε Android, και σε iOS από την αρχική οθόνη αφού εγκαταστήσετε το Wallos ως εφαρμογή.",
    "no_devices_registered" => "Δεν έχουν καταχωρηθεί συσκευές ακόμα.",
    "unknown_device" => "Άγνωστη συσκευή",
    "enable_on_this_device" => "Ενεργοποίηση σε αυτή τη συσκευή",
    ...
    "ai_provider_error" => "Σφάλμα παρόχου AI",
    "ai_invalid_response" => "Ο πάροχος AI επέστρεψε μη έγκυρη απάντηση.",
    "ai_invalid_json_response" => "Η απάντηση AI δεν περιείχε έγκυρες προτάσεις.",
    ...
    "remove_background_info" => "Αυτό δημιουργεί επίσης μια δεύτερη, επαναχρωματισμένη έκδοση του λογότυπου, ώστε να παραμένει ευανάγνωστο όταν εναλλάσσετε ανάμεσα σε ανοιχτό και σκούρο θέμα.",
    ...
    "registrations_disable_login_info" => "Ενεργοποιώντας τις εγγραφές χρηστών, η ρύθμιση απενεργοποίησης της σύνδεσης δεν θα είναι διαθέσιμη.",
    ...
    "require_email_verified_linking" => "Απαιτείται επαληθευμένο email για τη σύνδεση λογαριασμού",
    "oidc_email_not_verified" => "Αποτυχία σύνδεσης: η διεύθυνση email σας δεν έχει επαληθευτεί από τον πάροχο ταυτότητας.",
    ...
    "ssrf_allowlist_env_managed" => "Διαχειρίζεται από τη μεταβλητή περιβάλλοντος SSRF_ALLOWLIST.",
    "allow_standard_users_local_webhooks" => "Να επιτρέπεται στους απλούς χρήστες η χρήση της λίστας επιτρεπόμενων Webhook",
    "allow_standard_users_local_webhooks_info" => "Κίνδυνος ασφαλείας: η ενεργοποίηση αυτού επιτρέπει σε κάθε απλό χρήστη (μη διαχειριστή) να στέλνει ειδοποιήσεις στις διευθύνσεις της παραπάνω λίστας επιτρεπόμενων Webhook, συμπεριλαμβανομένων εσωτερικών υπηρεσιών στο δίκτυό σας. Ενεργοποιήστε το μόνο αν εμπιστεύεστε κάθε χρήστη αυτής της εγκατάστασης Wallos.",
    ...
    "auth_tagline" => "Μάθετε πού πάνε τα χρήματά σας.",
    "auth_tagline_sub" => "Παρακολουθήστε τις συνδρομές σας, δείτε τα έξοδά σας και μην χάσετε καμία ανανέωση.",
    "overview" => "Επισκόπηση",
    "trends_and_forecast" => "Τάσεις & Πρόβλεψη",
    "history_and_lifetime" => "Ιστορικό & Σύνολο",
    "cost_per_day" => "Κόστος ανά ημέρα",
    "median_monthly_cost" => "Διάμεσο μηνιαίο κόστος συνδρομής",
    "cheapest_subscription" => "Φθηνότερη συνδρομή",
    "vs_last_month" => "σε σχέση με τον προηγούμενο μήνα",
    "heaviest_month" => "Ακριβότερος επερχόμενος μήνας",
    "months_over_budget" => "Μήνες πάνω από τον προϋπολογισμό (επόμενοι 12)",
    "manual_renewals" => "Χειροκίνητες ανανεώσεις",
    "all_time_spend" => "Συνολικές δαπάνες (εκτ.)",
    "oldest_subscription" => "Παλαιότερη συνδρομή (έτη)",
    "average_subscription_age" => "Μέση ηλικία συνδρομών (έτη)",
    "projected_cost" => "Προβλεπόμενο κόστος (επόμενοι 12 μήνες)",
    "lifetime_spend" => "Συνολικές δαπάνες (Top 10, εκτ.)",
    "billing_cycle_split" => "Κατανομή ανά κύκλο χρέωσης",
    "currency_split" => "Κατανομή ανά νόμισμα",
    "price_distribution" => "Κατανομή τιμών",
    "subscriptions_count" => "Συνδρομές",
    "new_subscriptions_per_year" => "Νέες συνδρομές ανά έτος",
    "estimated_from_current_prices" => "Εκτίμηση βάσει τρεχουσών τιμών",
    "translate_categories" => "Μετάφραση με AI",
    "week_starts_on_sunday" => "Έναρξη εβδομάδας από Κυριακή στο ημερολόγιο",
